    ...
    <div className="flex flex-col">
      ...
      <section className="min-h-[70vh] md:min-h-[80vh] flex flex-col justify-center pt-20 md:pt-0">
        <div className="group w-fit cursor-default">
          <h1 className="font-display text-4xl md:text-7xl lg:text-8xl leading-[1.1] md:leading-[1.1] tracking-tight mb-6 md:mb-8 whitespace-pre-line transition-all duration-300">
        ...
        <p className="text-base md:text-2xl text-neutral-400 max-w-2xl leading-relaxed mb-8 md:mb-12">
          {t.hero.subtitle}
        </p>
        <div>
          <Link
      ...
      <section className="py-24 border-t border-neutral-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
          {t.services.items.map((service) => (
            <div key={service} className="border-b border-neutral-900 pb-8 hover:pl-4 transition-all duration-300 cursor-default">
